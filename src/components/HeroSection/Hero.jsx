...
const Hero = () => {
  ...
  const imagesData = [
    ...
    },
    {
      ...
      description: 'Our Banking & Finance practise area is well regarded for its expertise in advising in both contentious and non-contentious matters',
      buttonLabel: 'Our Services',
      linkTo: '/services',
    },
    {
      ...
      description: 'Our Asset Tracing & Recoveries practice area is a recognised leader in advising both contentious and noncontentious complex tracing and recovery of assets and in restructuring & insolvencies.',
      buttonLabel: 'Our Services',
      linkTo: '/services',
    }
  ];
  ...
  return (
    <div style={{ position: 'relative', height: '90vh' }}>
      ...
      <div style={overlayStyle}>
        ...
        <button className="btn btn-primary mt-6" style={buttonStyle}>{imagesData[currentIndex].buttonLabel}</button>
